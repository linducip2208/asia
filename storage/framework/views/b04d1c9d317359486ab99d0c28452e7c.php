...
<?php endif; ?>
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-950 dark:text-white"><?php echo e($this->totalCount); ?></p>
                </div>
            </div>
        </div>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                            <td class="px-4 py-3 font-medium text-gray-950 dark:text-white"><?php echo e($product->name); ?></td>
                            <td class="px-4 py-3 text-gray-500 dark:text-gray-400"><?php echo e($product->sku ?? '-'); ?></td>
                            <td class="px-4 py-3 text-right"><span class="inline-flex rounded-md bg-danger-100 px-2 py-0.5 text-xs font-semibold text-danger-700 dark:bg-danger-500/10 dark:text-danger-400"><?php echo e($product->current_stock); ?></span></td>
                            <td class="px-4 py-3 text-right text-gray-500 dark:text-gray-400"><?php echo e($product->min_stock); ?></td>
                        </tr>
        ...
        <div><?php echo e($this->products->links()); ?></div>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
