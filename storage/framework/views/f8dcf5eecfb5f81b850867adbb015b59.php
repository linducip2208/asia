<div>
    <div class="flex flex-wrap gap-3 items-end mb-6">
        ...
        <div class="ml-auto flex gap-2">
            <a href="<?php echo e(route('export.stock', ['outlet_id' => $this->outletId, 'format' => 'csv'])); ?>"
            ...
            <a href="<?php echo e(route('export.stock', ['outlet_id' => $this->outletId, 'format' => 'pdf'])); ?>"
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            ...
            <div class="text-2xl font-extrabold text-gray-900">Rp <?php echo e(number_format($this->totalStockValue, 0, ',', '.')); ?></div>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            <div class="text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1">Total Produk</div>
            <div class="text-2xl font-extrabold text-gray-900"><?php echo e(number_format($this->totalProducts, 0, ',', '.')); ?></div>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            <div class="text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1">Stok Menipis</div>
            <div class="text-2xl font-extrabold <?php echo e($this->lowStockCount > 0 ? 'text-rose-600' : 'text-gray-900'); ?>"><?php echo e(number_format($this->lowStockCount, 0, ',', '.')); ?></div>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            <div class="text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1">Kategori</div>
            <div class="text-2xl font-extrabold text-gray-900"><?php echo e(count($this->categoryLabels)); ?></div>
        </div>
    </div>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->lowStockCount > 0): ?>
    <div class="bg-white rounded-xl shadow-sm border border-rose-200 p-5 mb-6">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->lowStockProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="border-b border-rose-50">
                        <td class="py-3 font-medium text-rose-800"><?php echo e($product->name); ?></td>
                        <td class="py-3 text-right font-mono text-xs text-rose-600"><?php echo e($product->sku); ?></td>
                        <td class="py-3 text-right font-bold text-rose-600"><?php echo e(number_format($product->current_stock)); ?></td>
                        <td class="py-3 text-right text-rose-500"><?php echo e(number_format($product->min_stock)); ?></td>
                        <td class="py-3 text-right text-rose-500">Rp <?php echo e(number_format($product->cost_price, 0, ',', '.')); ?></td>
                    </tr>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </tbody>
            </table>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->topStockedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="border-b border-gray-50">
                            <td class="py-3 text-gray-400"><?php echo e($i + 1); ?></td>
                            <td class="py-3 font-medium"><?php echo e($product->name); ?></td>
                            <td class="py-3 text-right"><?php echo e(number_format($product->current_stock)); ?></td>
                            <td class="py-3 text-right font-medium">Rp <?php echo e(number_format($product->current_stock * $product->cost_price, 0, ',', '.')); ?></td>
                        </tr>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->stockMovements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="border-b border-gray-50">
                        <td class="py-3 text-gray-500"><?php echo e($movement->created_at->format('d M Y H:i')); ?></td>
                        <td class="py-3 font-medium"><?php echo e($movement->product?->name ?? '-'); ?></td>
                        <td class="py-3 text-gray-500"><?php echo e($movement->outlet?->name ?? '-'); ?></td>
                        <td class="py-3 text-center">
                            ...
                            ?>
                            <span class="inline-block px-2 py-0.5 rounded text-xs font-semibold bg-<?php echo e($color); ?>-100 text-<?php echo e($color); ?>-700"><?php echo e($label); ?></span>
                        </td>
                        <td class="py-3 text-right font-medium <?php echo e($movement->type === 'out' ? 'text-rose-600' : 'text-emerald-600'); ?>">
                            <?php echo e($movement->type === 'out' ? '-' : '+'); ?><?php echo e(number_format($movement->quantity)); ?>

                        </td>
                        <td class="py-3 text-gray-500"><?php echo e($movement->reference_type ? ucfirst($movement->reference_type) . ' #' . $movement->reference_id : '-'); ?></td>
                    </tr>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <tr>
...
(function() {
    ...
    const categoryLabels = <?php echo json_encode($this->categoryLabels); ?>;
    const categoryData = <?php echo json_encode($this->categoryData); ?>;
...
<?php /**PATH D:\project laravel\erpasia\resources\views\filament\pages\laporan-stok.blade.php ENDPATH**/ ?>