        ...
        <div class="relative pointer-events-auto w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="relative bg-gradient-to-br from-blue-600 via-blue-700 to-slate-900 text-white p-8 overflow-hidden">
                ...
                <div class="relative">
                    ...
                    <h2 class="text-3xl font-extrabold leading-tight mb-2">Butuh <?php echo e($brandName); ?>?</h2>
            ...
            <div class="p-6 space-y-4">
                <ul class="space-y-2.5 text-sm text-slate-700">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $posFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <li class="flex items-start gap-2"><span class="text-emerald-500 font-bold">&check;</span><span><?php echo e($feature); ?></span></li>
                ...
                <div class="bg-slate-100 rounded-2xl p-4">
                    ...
                    <div class="font-mono font-bold text-slate-900">+62 <?php echo e(substr($waNumber, 2)); ?></div>
                ...
                <a href="<?php echo e($waLink); ?>" target="_blank" rel="noopener"
                   class="block w-full py-4 bg-gradient-to-br from-emerald-500 to-emerald-700 text-white text-center rounded-2xl font-bold shadow-xl shadow-emerald-500/30 hover:shadow-2xl active:scale-[0.98] transition">
                    Chat WhatsApp Sekarang — <?php echo e($posPrice); ?>
...
<?php /**PATH D:\project laravel\erpasia\resources\views\components\purchase-cta.blade.php ENDPATH**/ ?>