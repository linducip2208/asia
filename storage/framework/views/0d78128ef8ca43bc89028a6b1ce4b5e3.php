...
<body>
    ...
    <div class="summary">
        ...
        <div class="summary-card">
            ...
            <div class="value" style="color: #059669;">Rp <?php echo e(number_format($paidRevenue, 0, ',', '.')); ?></div>
        </div>
        <div class="summary-card">
            <div class="label">Belum Dibayar</div>
            <div class="value" style="color: #d97706;">Rp <?php echo e(number_format($pendingRevenue, 0, ',', '.')); ?></div>
        </div>
        <div class="summary-card">
            <div class="label">DP / Partial</div>
            <div class="value" style="color: #6366f1;">Rp <?php echo e(number_format($partialRevenue, 0, ',', '.')); ?></div>
        </div>
        <div class="summary-card">
    ...
    <table>
        ...
        <tbody>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <tr>
...
<?php /**PATH D:\project laravel\erpasia\resources\views\pdf\laporan-keuangan.blade.php ENDPATH**/ ?>