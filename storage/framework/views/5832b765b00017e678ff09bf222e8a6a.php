...
<head>
    ...
    ?>
    <title><?php echo e($appName); ?> — Solusi Kasir Modern untuk Toko Anda</title>
    <meta name="description" content="<?php echo e($appName); ?> adalah sistem kasir modern untuk toko retail Indonesia. Kelola produk, transaksi, inventori, pelanggan, dan laporan dalam satu dashboard.">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="<?php echo e(config('app.url')); ?>/">
    <meta property="og:title" content="<?php echo e($appName); ?> — Solusi Kasir Modern untuk Toko Anda">
    ...
    <meta name="twitter:title" content="<?php echo e($appName); ?> — Solusi Kasir Modern untuk Toko Anda">
        ...
        <div class="flex items-center justify-between h-16">
            <a href="/" class="flex items-center gap-2.5 group">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoUrl): ?>
                    <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e($appName); ?>" class="h-8 w-auto">
                <?php else: ?>
                ...
                <span class="font-bold text-lg tracking-tight"><?php echo e($appName); ?></span>
            </a>
...
<footer class="bg-gray-950 text-gray-400 py-16">
    <div class="max-w-6xl mx-auto px-4">
        <div class="grid md:grid-cols-4 gap-10 mb-12">
            <div class="md:col-span-1">
                <div class="flex items-center gap-2.5 mb-4">
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <span class="font-bold text-white text-lg"><?php echo e($appName); ?></span>
                </div>
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($appName); ?>. Seluruh hak cipta dilindungi.</p>
            <p class="text-gray-500">Dibangun dengan <span class="text-red-400">&hearts;</span> di Indonesia</p>
        </div>
    </div>
</footer>

<?php echo $__env->make('components.purchase-cta', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH D:\project laravel\erpasia\resources\views/marketing.blade.php ENDPATH**/ ?>