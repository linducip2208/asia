...
<main class="max-w-4xl mx-auto px-4 py-10">
    ...
    <section class="bg-gradient-to-br from-blue-700 via-blue-800 to-slate-900 text-white rounded-3xl p-10 md:p-16 mb-10 text-center">
        ...
        <h1 class="text-3xl md:text-5xl font-extrabold mb-6 leading-tight"><?php echo e($seoMeta['title']); ?></h1>
        <p class="text-blue-200 text-lg mb-10 max-w-2xl mx-auto leading-relaxed"><?php echo e($seoMeta['description']); ?></p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://wa.me/<?php echo e($waNumber); ?>?text=Halo%20saya%20mau%20beli%20source%20code%20<?php echo e(urlencode($brand)); ?>" target="_blank"
        ...
        <div class="mt-8 flex justify-center gap-2 text-sm text-blue-200">
            <span>WhatsApp:</span>
            <span class="font-bold text-white">+62 <?php echo e(substr($waNumber, 2)); ?></span>
        </div>
    </section>

    
    <article class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-12 mb-8">
        <h2 class="text-2xl font-extrabold text-gray-900 mb-6">Kenapa Memilih Source Code <?php echo e($brand); ?>?</h2>
        ...
        <h3 class="text-xl font-bold text-gray-900 mb-4">Fitur Lengkap <?php echo e($brand); ?></h3>
    ...
    <div class="bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-3xl p-8 md:p-12 text-center">
        <h2 class="text-2xl md:text-3xl font-extrabold mb-4">Siap Memiliki Source Code <?php echo e($brand); ?>?</h2>
        ...
        <a href="https://wa.me/<?php echo e($waNumber); ?>?text=Halo%20saya%20mau%20beli%20source%20code%20<?php echo e(urlencode($brand)); ?>" target="_blank"
           class="inline-block px-10 py-4 bg-emerald-500 hover:bg-emerald-600 text-white rounded-2xl font-bold text-lg shadow-xl shadow-emerald-500/40 transition hover:-translate-y-0.5">
            Beli Source Code — <?php echo e($sourceCodePrice); ?>
    ...
    <div class="mt-10">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-2">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $topCities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <a href="/aplikasi-pos-<?php echo e(\Illuminate\Support\Str::slug($c['name'])); ?>" class="text-sm text-blue-600 hover:text-blue-800 hover:underline py-1">
                    Aplikasi POS <?php echo e($c['name']); ?>
...
<footer class="bg-gray-900 text-gray-400 py-10 mt-12">
    <div class="max-w-4xl mx-auto px-4 text-center text-sm">
        <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($brand); ?>. Source Code Aplikasi Point of Sale. Beli source code POS, lifetime update.</p>
    </div>
</footer>
</body>
</html>
<?php /**PATH D:\project laravel\erpasia\resources\views\pseo\landing.blade.php ENDPATH**/ ?>