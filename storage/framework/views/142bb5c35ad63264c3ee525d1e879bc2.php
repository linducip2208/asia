  ...
  <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
    ...
    <div class="p-7 space-y-5 fade-up">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($data['license']['support_until'])): ?>
        <div class="bg-slate-50 border border-slate-200 rounded-xl p-4">
          <div class="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-2 flex items-center gap-1.5">
...
<?php /**PATH D:\project laravel\erpasia\resources\views\license\pair-success.blade.php ENDPATH**/ ?>