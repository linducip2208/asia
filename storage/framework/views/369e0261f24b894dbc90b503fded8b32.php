...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="text-xl font-bold text-emerald-600">Rp <?php echo e(number_format($totals['sales'] ?? 0, 0, ',', '.')); ?></div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="text-xl font-bold text-amber-600">Rp <?php echo e(number_format($totals['purchases'] ?? 0, 0, ',', '.')); ?></div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalee08b1367eba38734199cf7829b1d1e9)): ?>
<?php $attributes = $__attributesOriginalee08b1367eba38734199cf7829b1d1e9; ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="text-xl font-bold text-rose-600">Rp <?php echo e(number_format($totals['expenses'] ?? 0, 0, ',', '.')); ?></div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalee08b1367eba38734199cf7829b1d1e9)): ?>
<?php $attributes = $__attributesOriginalee08b1367eba38734199cf7829b1d1e9; ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="text-xl font-bold <?php echo e(($totals['profit'] ?? 0) >= 0 ? 'text-emerald-600' : 'text-rose-600'); ?>">Rp <?php echo e(number_format($totals['profit'] ?? 0, 0, ',', '.')); ?></div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalee08b1367eba38734199cf7829b1d1e9)): ?>
<?php $attributes = $__attributesOriginalee08b1367eba38734199cf7829b1d1e9; ?>
            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100">
                        <td class="py-2"><?php echo e(\Carbon\Carbon::parse($row['date'])->format('d/m/Y')); ?></td>
                        <td class="py-2 text-right">Rp <?php echo e(number_format($row['sales'], 0, ',', '.')); ?></td>
                        <td class="py-2 text-right">Rp <?php echo e(number_format($row['purchases'], 0, ',', '.')); ?></td>
                        <td class="py-2 text-right">Rp <?php echo e(number_format($row['expenses'], 0, ',', '.')); ?></td>
                        <td class="py-2 text-right font-semibold <?php echo e($row['profit'] >= 0 ? 'text-emerald-600' : 'text-rose-600'); ?>">Rp <?php echo e(number_format($row['profit'], 0, ',', '.')); ?></td>
                    </tr>
...
<?php endif; ?>
<?php /**PATH D:\project laravel\erpasia\resources\views\filament\pages\laporan\rekap-harian.blade.php ENDPATH**/ ?>