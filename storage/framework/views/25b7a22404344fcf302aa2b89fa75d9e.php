...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "LocalBusiness",
        "name": "POS Retail <?php echo e($cityName); ?>",
        "description": "<?php echo e($seoMeta['description']); ?>",
        <?php if(isset($outlets[0])): ?>
        "address": { "@type": "PostalAddress", "streetAddress": "<?php echo e($outlets[0]->address); ?>" },
        "telephone": "<?php echo e($outlets[0]->phone); ?>",
        <?php endif; ?>
        "@id": "<?php echo e($seoMeta['canonical']); ?>"
    }
    </script>
</head>
<body class="bg-gray-50 min-h-screen">
    ...
    <main class="max-w-6xl mx-auto px-4 py-8">
        <h1 class="text-3xl font-extrabold text-gray-900 mb-2">Toko Retail di <?php echo e($cityName); ?></h1>
        <p class="text-gray-600 mb-8">Kunjungi toko kami di <?php echo e($cityName); ?>. Produk lengkap, harga terbaik, bisa beli grosir dan eceran.</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition">
                <h3 class="font-bold text-gray-900 text-lg mb-2"><?php echo e($outlet->name); ?></h3>
                <div class="space-y-2 text-sm text-gray-600">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span><?php echo e($outlet->phone); ?></span>
                    </div>
                    <div class="flex items-center gap-2">
...
<?php /**PATH D:\project laravel\erpasia\resources\views\pseo\store-location.blade.php ENDPATH**/ ?>