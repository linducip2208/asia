...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="text-2xl font-bold"><?php echo e($totalReturns); ?></div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="text-2xl font-bold text-rose-600">Rp <?php echo e(number_format($totalAmount, 0, ',', '.')); ?></div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalee08b1367eba38734199cf7829b1d1e9)): ?>
<?php $attributes = $__attributesOriginalee08b1367eba38734199cf7829b1d1e9; ?>
            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100">
                        <td class="py-2 font-mono text-xs"><?php echo e($row->return_number); ?></td>
                        <td class="py-2"><?php echo e($row->type === 'customer_return' ? 'Customer' : 'Supplier'); ?></td>
                        ...
                        <td class="py-2 text-gray-500"><?php echo e($row->reason ?: '-'); ?></td>
                        <td class="py-2"><span class="px-2 py-0.5 rounded-full text-xs bg-gray-100 text-gray-600"><?php echo e($row->status); ?></span></td>
                        <td class="py-2 text-gray-500"><?php echo e(\Carbon\Carbon::parse($row->created_at)->format('d/m/Y')); ?></td>
                    </tr>
...
<?php endif; ?>
<?php /**PATH D:\project laravel\erpasia\resources\views\filament\pages\laporan\return.blade.php ENDPATH**/ ?>