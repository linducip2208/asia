<div>
    <div class="flex flex-wrap gap-3 items-end mb-6">
        ...
        <div class="ml-auto flex gap-2">
            <a href="<?php echo e(route('export.sales', ['start_date' => $this->startDate, 'end_date' => $this->endDate, 'outlet_id' => $this->outletId, 'format' => 'csv'])); ?>"
            ...
            <a href="<?php echo e(route('export.sales', ['start_date' => $this->startDate, 'end_date' => $this->endDate, 'outlet_id' => $this->outletId, 'format' => 'pdf'])); ?>"
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            ...
            <div class="text-2xl font-extrabold text-gray-900">Rp <?php echo e(number_format($this->totalSales, 0, ',', '.')); ?></div>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            <div class="text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1">Total Transaksi</div>
            <div class="text-2xl font-extrabold text-gray-900"><?php echo e(number_format($this->totalOrders, 0, ',', '.')); ?></div>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            <div class="text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1">Rata-rata / Transaksi</div>
            <div class="text-2xl font-extrabold text-gray-900">Rp <?php echo e(number_format($this->avgOrder, 0, ',', '.')); ?></div>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            <div class="text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1">Total Diskon</div>
            <div class="text-2xl font-extrabold text-amber-600">Rp <?php echo e(number_format($this->totalDiscount, 0, ',', '.')); ?></div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 mb-6">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody>
                    <?php $revTotal = $this->revenueByPayment->sum('total'); ?>
                    ...
                    <tr class="border-b border-gray-50">
                        ...
                        <td class="py-3 text-right"><?php echo e($revTotal > 0 ? round(($item->total / $revTotal) * 100) : 0); ?>%</td>
                    </tr>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 mb-6">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->paymentsDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="border-b border-gray-50 hover:bg-gray-50/50">
                        <td class="py-3 text-gray-400"><?php echo e($i + 1); ?></td>
                        <td class="py-3 font-mono text-xs"><?php echo e($p->order_number); ?></td>
                        <td class="py-3"><?php echo e($p->customer_name ?: '-'); ?></td>
                        <td class="py-3 text-xs text-gray-500"><?php echo e($p->outlet_name ?: '-'); ?></td>
                        <td class="py-3">
                            <span class="px-2 py-0.5 rounded-full text-xs font-semibold
                                <?php echo e($p->method === 'Cash' || $p->method === 'Tunai' ? 'bg-emerald-100 text-emerald-700' : ''); ?>

                                <?php echo e($p->method === 'QRIS' ? 'bg-indigo-100 text-indigo-700' : ''); ?>

                                <?php echo e($p->method === 'Transfer' || $p->method === 'Debit' ? 'bg-amber-100 text-amber-700' : ''); ?>">
                                <?php echo e($p->method); ?>

                            </span>
                        </td>
                        <td class="py-3 text-right font-medium">Rp <?php echo e(number_format($p->amount, 0, ',', '.')); ?></td>
                        <td class="py-3 text-xs text-gray-500"><?php echo e(\Carbon\Carbon::parse($p->created_at)->format('d/m/y H:i')); ?></td>
                    </tr>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->topProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="border-b border-gray-50">
                        <td class="py-3 text-gray-400"><?php echo e($i + 1); ?></td>
                        <td class="py-3 font-medium"><?php echo e($product->name); ?></td>
                        <td class="py-3 text-right"><?php echo e(number_format($product->total_qty)); ?></td>
                        <td class="py-3 text-right font-medium">Rp <?php echo e(number_format($product->total_revenue, 0, ',', '.')); ?></td>
                    </tr>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <tr>
...
(function() {
    ...
    el._chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Pendapatan',
                data: <?php echo json_encode($this->chartData); ?>,
...
<?php /**PATH D:\project laravel\erpasia\resources\views\filament\pages\laporan-penjualan.blade.php ENDPATH**/ ?>