            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search && strlen($search) >= 2): ?>
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="px-4 py-3 border-b border-gray-100 bg-gray-50">
                        <span class="text-sm font-semibold text-gray-700">Hasil Pencarian: <?php echo e($this->products->count()); ?> produk</span>
                    </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="border-b border-gray-50 last:border-b-0">
                            ...
                            ?>
                            <div
                                wire:click="toggleProduct('<?php echo e($productKey); ?>')"
                                class="flex items-center gap-3 px-4 py-3 cursor-pointer hover:bg-blue-50/50 transition-colors <?php echo e($isSelected ? 'bg-blue-50 border-l-4 border-l-blue-500' : ''); ?>"
                            >
                                <div class="shrink-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="font-semibold text-sm text-gray-900 truncate"><?php echo e($product->name); ?></div>
                                    <div class="flex items-center gap-2 text-xs text-gray-500 mt-0.5">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->barcode): ?>
                                            <span class="font-mono"><?php echo e($product->barcode); ?></span>
                                        <?php else: ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->has_variants && $product->variants->isNotEmpty()): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $product->variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    ...
                                    ?>
                                    <div
                                        wire:click="toggleProduct('<?php echo e($variantKey); ?>')"
                                        class="flex items-center gap-3 pl-10 pr-4 py-2 cursor-pointer hover:bg-blue-50/50 transition-colors <?php echo e($isVariantSelected ? 'bg-blue-50 border-l-4 border-l-blue-500' : ''); ?>"
                                    >
                                        <div class="shrink-0">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="text-sm text-gray-700 truncate"><?php echo e($variant->name); ?></div>
                                            <div class="text-xs text-gray-500 mt-0.5">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($variant->barcode): ?>
                                                    <span class="font-mono"><?php echo e($variant->barcode); ?></span>
                                                <?php else: ?>
                                                    <span class="text-rose-500">Belum ada barcode</span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div class="text-sm font-semibold text-gray-700 shrink-0">
                                            Rp <?php echo e(number_format($variant->selling_price, 0, ',', '.')); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 sticky top-4">
                <div class="px-4 py-3 border-b border-gray-100 bg-gray-50 flex items-center justify-between">
                    <span class="text-sm font-semibold text-gray-700">
                        Produk Dipilih (<?php echo e(count($selectedProducts)); ?>)
                    </span>
                ...
                <div class="divide-y divide-gray-50 max-h-[400px] overflow-y-auto">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $selectedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                            $parts = explode(':', $key);
                            $type = $parts[0] ?? '';
                            $id = $parts[1] ?? '';
                        ...
                        <div class="px-4 py-3">
                            <div class="flex items-start justify-between gap-2">
                                <div class="flex-1 min-w-0">
                                    <div class="text-sm font-medium text-gray-900 truncate"><?php echo e($name); ?></div>
                                    <div class="text-xs font-mono text-gray-500 mt-0.5"><?php echo e($barcode ?: 'Tanpa barcode'); ?></div>
                                    <div class="text-xs text-gray-500">Rp <?php echo e(number_format($price, 0, ',', '.')); ?></div>
                                </div>
                                <button
                                    wire:click="removeProduct('<?php echo e($key); ?>')"
                            ...
                            <div class="flex items-center gap-2 mt-2">
                                ...
                                <input
                                    type="number"
                                    wire:model.live="quantities.<?php echo e($key); ?>"
                                    min="1"
                                    max="100"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($selectedProducts) > 0): ?>
                    <div class="px-4 py-3 border-t border-gray-100">
                        ...
                        >
                            ...
                            Cetak Label (<?php echo e(count($selectedProducts)); ?> produk)
                        </button>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($selectedProducts) > 0): ?>
        <?php
        $__scriptKey = '3078564893-0';
        ob_start();
    ?>
    <script>
        window.printBarcodeLabels = function() {
            const items = <?php echo json_encode($this->selectedItems, 15, 512) ?>;
...
<body onload="window.print(); setTimeout(function(){ window.close(); }, 500);">
    ...
    ?>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH D:\project laravel\erpasia\resources\views\filament\pages\cetak-label-barcode.blade.php ENDPATH**/ ?>