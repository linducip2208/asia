...
<h1 class="text-2xl font-extrabold text-gray-900 mb-1">Produk <?php echo e($brand->name); ?></h1>
<p class="text-gray-500 mb-6"><?php echo e($brand->description); ?></p>
...
<?php echo $__env->make('pseo._layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project laravel\erpasia\resources\views\pseo\brand-page.blade.php ENDPATH**/ ?>