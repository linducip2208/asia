...
<head>
    ...
    <title>Kontak — <?php echo e(config('app.name')); ?></title>
...
<body class="font-sans bg-stone-50 text-slate-800 antialiased">
    <nav class="sticky top-0 z-50 bg-white/80 backdrop-blur-lg border-b border-slate-200">
        <div class="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 font-bold text-xl text-slate-900"><span class="text-2xl">🏪</span> <?php echo e(config('app.name')); ?></a>
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('home')); ?>" class="text-sm text-slate-600 hover:text-blue-600 transition">Beranda</a>
                <a href="<?php echo e(route('blog.index')); ?>" class="text-sm text-slate-600 hover:text-blue-600 transition">Blog</a>
    ...
    <div class="max-w-4xl mx-auto px-4 py-16">
        ...
        <div class="mt-12 bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <a href="<?php echo e(route('blog.index')); ?>" class="px-4 py-3 bg-slate-50 rounded-xl text-sm font-medium text-slate-700 hover:bg-blue-50 hover:text-blue-600 transition text-center">Blog</a>
                <a href="<?php echo e(route('faq')); ?>" class="px-4 py-3 bg-blue-50 rounded-xl text-sm font-medium text-blue-600 transition text-center">FAQ</a>
                <a href="<?php echo e(route('login')); ?>" class="px-4 py-3 bg-slate-50 rounded-xl text-sm font-medium text-slate-700 hover:bg-blue-50 hover:text-blue-600 transition text-center">Demo</a>
            </div>
        </div>
    </div>
...
<?php /**PATH D:\project laravel\erpasia\resources\views\pages\contact.blade.php ENDPATH**/ ?>