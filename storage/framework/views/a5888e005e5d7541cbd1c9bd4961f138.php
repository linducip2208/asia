...
<head>
    ...
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"Article","headline":"<?php echo e($seoMeta['title']); ?>","description":"<?php echo e($seoMeta['description']); ?>","inLanguage":"id"}</script>
    <style>
            ...
            <div class="flex flex-col <?php echo e($idx % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'); ?> items-center gap-8 mb-12">
                <div class="md:w-1/2">
                    <div class="browser-mock">
                        ...
                        <img src="/marketing/screens/<?php echo e($item['screenshot'] ?? 'dashboard'); ?>.png" alt="<?php echo e($item['title']); ?>" class="w-full" loading="lazy" onerror="this.style.display='none';this.parentElement.innerHTML+='<div class=bg-gray-100 h-48 flex items-center justify-center text-gray-400>'+this.alt+'</div>'">
                    </div>
                </div>
                <div class="md:w-1/2">
...
<?php /**PATH D:\project laravel\erpasia\resources\views\pseo\docs-index-baru.blade.php ENDPATH**/ ?>