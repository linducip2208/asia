...
<body class="font-sans bg-gray-50" style="display:flex;flex-direction:column;height:100vh;overflow:hidden">
    ...
    <header class="bg-blue-600 text-white px-3 sm:px-4 py-2 flex items-center flex-wrap gap-2 sm:gap-4 shadow-lg z-10" style="flex-shrink:0">
        ...
        <div class="flex items-center gap-2 text-sm">
            <select id="customerId" class="bg-indigo-600 text-white rounded px-2 py-1 text-sm border border-indigo-500">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $orderTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            ...
            <select id="outletId" class="bg-indigo-600 text-white rounded px-2 py-1 text-sm border border-indigo-500">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $outlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        ...
        <span class="text-xs text-indigo-200"><?php echo e(auth()->user()->name); ?></span>
        <?php else: ?>
                ...
                <div class="space-y-1 text-sm">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="flex items-center gap-2">
                            ...
                            <span>Pajak (<span id="taxRateLabel"><?php echo e($taxPercent); ?></span>%)</span>
                        </span>
    ...
    <script>
        ...
        const RECEIPT = {
            appName: <?php echo json_encode($appName, 15, 512) ?>,
            appLogo: <?php echo json_encode($appLogo, 15, 512) ?>,
            footer: <?php echo json_encode($receiptFooter, 15, 512) ?>,
            receiptFooter: <?php echo json_encode($receiptFooter, 15, 512) ?>,
            storeAddress: <?php echo json_encode($storeAddress, 15, 512) ?>,
            storePhone: <?php echo json_encode($storePhone, 15, 512) ?>,
            showLogo: <?php echo json_encode($receiptShowLogo, 15, 512) ?>,
            showName: <?php echo json_encode($receiptShowName, 15, 512) ?>,
            showAddress: <?php echo json_encode($receiptShowAddress, 15, 512) ?>,
            showPhone: <?php echo json_encode($receiptShowPhone, 15, 512) ?>,
            showFooter: <?php echo json_encode($receiptShowFooter, 15, 512) ?>,
        };
    ...
    <script src="<?php echo e(asset('js/pos-printer.js')); ?>"></script>
</body>
</html>
<?php /**PATH D:\project laravel\erpasia\resources\views\pos\index.blade.php ENDPATH**/ ?>