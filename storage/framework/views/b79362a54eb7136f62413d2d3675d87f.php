...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="text-2xl font-bold text-emerald-600">Rp <?php echo e(number_format($totalTaxOutput, 0, ',', '.')); ?></div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalee08b1367eba38734199cf7829b1d1e9)): ?>
<?php $attributes = $__attributesOriginalee08b1367eba38734199cf7829b1d1e9; ?>
            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100">
                        ...
                        <td class="py-2 text-right">Rp <?php echo e(number_format($row->dpp, 0, ',', '.')); ?></td>
                        <td class="py-2 text-right font-semibold">Rp <?php echo e(number_format($row->tax, 0, ',', '.')); ?></td>
                    </tr>
...
<?php endif; ?>
<?php /**PATH D:\project laravel\erpasia\resources\views\filament\pages\laporan\pajak.blade.php ENDPATH**/ ?>