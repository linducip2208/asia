...
<body class="bg-gray-50 min-h-screen font-sans antialiased flex items-center justify-center px-4">
    ...
    <div class="w-full max-w-md">
        ...
        <form action="<?php echo e(route('portal.register')); ?>" method="POST" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 space-y-5">
            <?php echo csrf_field(); ?>
        ...
        <p class="mt-6 text-center text-sm text-gray-500">
            Sudah punya akun?
            <a href="<?php echo e(route('portal.login')); ?>" class="text-indigo-600 font-medium hover:text-indigo-700">Masuk di sini</a>
        </p>
    </div>

</body>
</html>
<?php /**PATH D:\project laravel\erpasia\resources\views/portal/auth/register.blade.php ENDPATH**/ ?>