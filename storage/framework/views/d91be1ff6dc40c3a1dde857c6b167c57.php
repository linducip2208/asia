            ...
            <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
                ...
                <div class="fi-section-content p-6 pt-0 grid gap-4">
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentLogo): ?>
                        <div class="mb-2 flex items-center gap-2">
                            <img src="<?php echo e($currentLogo); ?>" class="h-12 border rounded p-1">
...
<?php endif; ?>
<?php /**PATH D:\project laravel\erpasia\resources\views\filament\pages\settings\pengaturan-sistem.blade.php ENDPATH**/ ?>