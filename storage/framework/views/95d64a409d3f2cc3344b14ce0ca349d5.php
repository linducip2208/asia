...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="space-y-6">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($generatedToken): ?>
        <div class="rounded-xl bg-green-50 border border-green-300 p-4 dark:bg-green-900/20 dark:border-green-800">
            ...
            <div class="flex items-center gap-2">
                <code class="flex-1 bg-white dark:bg-gray-900 border rounded px-3 py-2 text-xs break-all font-mono"><?php echo e($generatedToken); ?></code>
                <button type="button" onclick="navigator.clipboard.writeText('<?php echo e($generatedToken); ?>')" class="text-xs bg-green-600 text-white px-3 py-1.5 rounded hover:bg-green-700 whitespace-nowrap">Copy</button>
            </div>
            ...
            <div class="fi-section-content p-6 pt-0">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tokens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $token): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                <td class="px-3 py-3 font-mono text-xs"><?php echo e($token->name); ?></td>
                                <td class="px-3 py-3 text-xs text-gray-500"><?php echo e($token->last_used_at ? $token->last_used_at->format('d M Y H:i:s') : 'Belum pernah'); ?></td>
                                <td class="px-3 py-3 text-xs text-gray-500"><?php echo e($token->created_at->format('d M Y H:i:s')); ?></td>
                                <td class="px-3 py-3">
                                    <button type="button" wire:click="revokeToken(<?php echo e($token->id); ?>)" wire:confirm="Revoke API key ini?" class="text-red-600 hover:text-red-800 text-xs underline">Revoke</button>
                                </td>
                            </tr>
...
<?php endif; ?>
<?php /**PATH D:\project laravel\erpasia\resources\views\filament\pages\integrasi\api-key.blade.php ENDPATH**/ ?>