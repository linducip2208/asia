...
<body class="font-sans bg-stone-50 antialiased">
    <div class="min-h-screen grid lg:grid-cols-2 gap-0">
        ...
        <div class="hidden lg:flex relative bg-gradient-to-br from-blue-700 via-blue-800 to-slate-900 p-12 flex-col justify-between overflow-hidden">
            ...
            <div class="relative">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 text-white">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoUrl): ?>
                        <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e($brandName); ?>" class="h-9 w-auto brightness-0 invert">
                    <?php else: ?>
                        <div class="w-10 h-10 bg-white/20 backdrop-blur rounded-xl flex items-center justify-center text-2xl">🏪</div>
                        <span class="font-semibold text-xl tracking-tight"><?php echo e($brandName); ?></span>
            ...
            <div class="relative text-blue-300/70 text-xs">
                &copy; <?php echo e(date('Y')); ?> <?php echo e($brandName); ?> &middot; Powered by Laravel
            </div>
        </div>
        ...
        <div class="flex items-center justify-center p-8 lg:p-16">
            <div class="w-full max-w-md">
                ...
                <p class="text-slate-500 mb-8">Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="text-blue-600 font-semibold hover:underline">Daftar gratis</a></p>
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-blue-600 font-semibold hover:underline">Lupa password?</a>
                    </div>
                ...
                <div class="bg-slate-50 border border-slate-200 rounded-xl p-4 text-sm">
                    ...
                    <div class="space-y-1 text-slate-600 text-xs font-mono">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $demoAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div><span class="font-bold"><?php echo e($account['role']); ?>:</span> <?php echo e($account['email']); ?> / <?php echo e($account['password']); ?></div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php /**PATH D:\project laravel\erpasia\resources\views\auth\login.blade.php ENDPATH**/ ?>