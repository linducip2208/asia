...
<body>
    <div class="header">
        <h1>LAPORAN STOK</h1>
        <p>Tanggal: <?php echo e(now()->format('d M Y')); ?></p>
    </div>
    ...
    <div class="summary">
        ...
        <div class="summary-card">
            ...
            <div class="value" style="color: #dc2626;"><?php echo e($lowStock->count()); ?></div>
        </div>
        <div class="summary-card">
            <div class="label">Overstock</div>
            <div class="value" style="color: #d97706;"><?php echo e($overStock->count()); ?></div>
        </div>
        <div class="summary-card">
            <div class="label">Nilai Inventori</div>
            <div class="value">Rp <?php echo e(number_format($totalInventoryValue, 0, ',', '.')); ?></div>
        </div>
    </div>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lowStock->count() > 0): ?>
    <div class="section-title">Produk Stok Rendah (<?php echo e($lowStock->count()); ?>)</div>
    <table>
        <thead>
            <tr>
                <th>SKU</th>
        ...
        <tbody>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $lowStock; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <tr>
                <td><?php echo e($p->sku); ?></td>
                <td class="danger"><?php echo e($p->name); ?></td>
                <td><?php echo e($p->category->name ?? '-'); ?></td>
                <td class="text-right danger"><?php echo e($p->current_stock); ?></td>
                <td class="text-right"><?php echo e($p->min_stock); ?></td>
                <td class="text-right">Rp <?php echo e(number_format($p->cost_price, 0, ',', '.')); ?></td>
                <td class="text-right">Rp <?php echo e(number_format($p->selling_price, 0, ',', '.')); ?></td>
            </tr>
    ...
    <div class="section-title">Semua Produk (<?php echo e($products->count()); ?>)</div>
    <table>
        <thead>
            <tr>
                <th>SKU</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right <?php echo e($p->current_stock <= $p->min_stock ? 'danger' : ''); ?>"><?php echo e($p->current_stock); ?></td>
                <td class="text-right"><?php echo e($p->min_stock); ?></td>
                <td class="text-right"><?php echo e($p->max_stock); ?></td>
                <td class="text-right">Rp <?php echo e(number_format($p->cost_price, 0, ',', '.')); ?></td>
                <td class="text-right">Rp <?php echo e(number_format($p->selling_price, 0, ',', '.')); ?></td>
                <td class="text-right">Rp <?php echo e(number_format($p->current_stock * $p->cost_price, 0, ',', '.')); ?></td>
            </tr>
...
<?php /**PATH D:\project laravel\erpasia\resources\views\pdf\laporan-stok.blade.php ENDPATH**/ ?>